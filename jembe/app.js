(() => {
  ...
  const INDEX = [
    ...
    { id: "about", title: "The Group", blurb: "Mauritius-incorporated advisory and investing group", terms: "eben incorporation east africa southern tanzania theatre" },
    { id: "sectors", title: "Five sectors", blurb: "Energy, infrastructure, insurance, agribusiness, mining", terms: "practice platform" },
    { id: "sector-energy", title: "Energy", blurb: "IPPs, PPAs, renewables, DFI engagement", terms: "solar hydro gas generation transmission tanesco minigrid" },
    ...
    { id: "network", title: "Network", blurb: "Infinity Star, Next Bridge, Mbegu, Ndege, CreditInvest, BQ", terms: "mbegu next bridge infinity ndege creditinvest associated" },
