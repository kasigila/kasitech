...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ["Appointments", "Services", "Client Care"],
    summary: "Beauty · Bookings · Client care",
    description:
      "Salon booking with services, stylist selection, packages, client notes, and owner operations.",
    hook: "Book a glow session",
    filters: ["commerce", "websites", "platforms"],
    routes: ["sell", "website", "platform"],
    keywords: [
      "beauty",
      "salon",
      "spa",
